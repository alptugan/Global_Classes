package src.com.filikatasarim.cpm.serra.items
{
	...
	public class SubCatItem extends CasaSprite
	{
		private var str:String;
		private var color:uint = 0xffffff;
		private var rectcolor:uint = 0xd98828;
		private var fontSize:int = 37;
		...
		private var w:int = 349;
		private var h:int = 230;
		...
		public function SubCatItem(str:String,bmp:Bitmap)
		{
			this.str = str;
			this.bmp = bmp;
