...
{
	import com.alptugan.Mail.CheckEmail;
	import com.alptugan.Mail.MailForm;
	...
	public class AEMailForm extends CasaSprite
	{
		private var checker    : CheckEmail;
		private var timer      : Timer;
		private var checkAlert : Boolean;
		private var debug_txt  : ATextSingleLine;
		...
		public function AEMailForm(_phpLoc : String, language:String="en"):void
		{
			phpLoc = _phpLoc;
			...
			if(this.language == "en")
				debug_txt = new ATextSingleLine("All fields are required",FontNamesFB.regular,Colors.cTomato,8,false,false);
			else
				debug_txt = new ATextSingleLine("Lütfen bütün boş alanları doldurun",FontNamesFB.regular,Colors.cTomato,8,true,false);
			addChild(debug_txt);
		...
		private function onComplete(e:Event):void
		{
			...
			if(vars.answer=='ok')
				if(this.language == "en")
					...
					debug_txt.SetText('Mesajın bana ulaştı.');
				else
					if(this.language == "en")
