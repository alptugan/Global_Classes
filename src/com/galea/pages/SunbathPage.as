package src.com.galea.pages
{
	...
	public class SunbathPage extends Page
	{
		public var base:PageBase;
		private var cont:AText;
		
		public function SunbathPage()
		{
			super();
		}
		...
		override protected function onAddedToStage(e:Event):void 
		{
			...
			cont = new AText(styleGalea.p,String(Globals.SunXML.item[0].name),500,styleGalea.pSize,styleGalea.pColor);
			...
			var slide:ASimpleSlideShow = new ASimpleSlideShow(Globals.SunXML,0, 308,3,"default");
			slide.isXML = true;
			addChild(slide);
