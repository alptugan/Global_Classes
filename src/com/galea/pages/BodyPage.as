package src.com.galea.pages
{
	...
	public class BodyPage extends Page
	{
		...
		override protected function onAddedToStage(e:Event):void 
		{
			...
			cont = new AText(styleGalea.p,String(Globals.BodyXML.item[0].name),500,styleGalea.pSize,styleGalea.pColor);
			...
			var slide:ASimpleSlideShow = new ASimpleSlideShow(Globals.BodyXML,0, 308,3,"default");
			slide.isXML = true;
			addChild(slide);
