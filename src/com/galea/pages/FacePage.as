package src.com.galea.pages
{
	...
	public class FacePage extends Page
	{
		...
		override protected function onAddedToStage(e:Event):void 
		{
			...
			cont = new AText(styleGalea.p,String(Globals.FaceXML.item[0].name),500,styleGalea.pSize,styleGalea.pColor);
			...
			var slide:ASimpleSlideShow = new ASimpleSlideShow(Globals.FaceXML,0, 308,3,"default");
			slide.isXML = true;
			addChild(slide);
