package src.com.galea.pages
{
	...
	public class MakeupPage extends Page
	{
		public var base:PageBase;
		private var cont:AText;
		
		public function MakeupPage()
		{
			super();
		}
		...
		override protected function onAddedToStage(e:Event):void 
		{
			...
			cont = new AText(styleGalea.p,String(Globals.MakeXML.item[0].name),500,styleGalea.pSize,styleGalea.pColor);
			...
			var slide:ASimpleSlideShow = new ASimpleSlideShow(Globals.MakeXML,0, 308,3,"default");
			slide.isXML = true;
			addChild(slide);
