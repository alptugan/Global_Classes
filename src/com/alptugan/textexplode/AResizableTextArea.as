package src.com.alptugan.textexplode
{
	...
	public class AResizableTextArea extends Sprite
	{
		...
		public function AResizableTextArea( _Str : String,_TfWidth : int = 560,_TfHeight : int = 350 )
		{
			Str = _Str;
			TfHeight = _TfHeight;
			TfWidth = _TfWidth;
		...
		private function init( e : Event ) : void
		{
			...
			Text = new AText('regular',Str,TfWidth,12,0xffffff);
			Text.lineSpace = 1.3;
			Text.alpha = 0;
