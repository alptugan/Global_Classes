...
//   All rights reserved. 
//------------------------------------------------------------------------------
package com.alptugan.text.FontLoader
{
	import com.alptugan.events.FontLoaderEvent;
	...
	public class FontClass extends Sprite
	{
		...
		public function FontClass( _Source : String = "asset/Font-Arial.swf",cssPath : String = "resources/style.css" )
		{
...
//		_textField.rotationX = 5;
		...
		{
			fEvt = new FontLoaderEvent( "fontsLoading" );
