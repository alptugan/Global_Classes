package com.alptugan.Mail
{
	...
	public class AMailForm extends CasaSprite
	{
		...
		private function init(e:Event):void
		{
			...
			Mail_Message = new AEMailForm (php_path);
			...
			/**Input Fields**/
			Input_Name     = new AInputText(FontNamesFB.regular, Colors.cWhite,Colors.cGrayIV,InputTxtW,InputTxtH,Colors.cGrayIII,10,Colors.cWhite,Name,1);
			Input_Email    = new AInputText(FontNamesFB.regular,Colors.cWhite,Colors.cGrayIV,InputTxtW,InputTxtH,Colors.cGrayIII,10,Colors.cWhite,Email,2);
			Input_Subject  = new AInputText(FontNamesFB.regular,Colors.cWhite,Colors.cGrayIV,InputTxtW,InputTxtH,Colors.cGrayIII,10,Colors.cWhite,Subject,3);
			Input_Message  = new AInputText(FontNamesFB.regular,Colors.cWhite,Colors.cGrayIV,InputTxtW,124,Colors.cGrayIII,10,Colors.cWhite,Message,4);
