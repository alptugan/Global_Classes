...
package com.usual{
	 ...
	 */
	[Event(name='init', type='com.usual.SWFAddressEvent')]
	/**
	 * Dispatched when any value change.
	 */
	[Event(name='change', type='com.usual.SWFAddressEvent')]
	/**
	 * Dispatched when value was changed by Flash.
	 */
	[Event(name='internalChange', type='com.usual.SWFAddressEvent')]
	/**
	 * Dispatched when value was changed by Browser.
	 */
	[Event(name='externalChange', type='com.usual.SWFAddressEvent')]
