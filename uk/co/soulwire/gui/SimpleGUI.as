...
package uk.co.soulwire.gui
{
	...
	public class SimpleGUI extends EventDispatcher
	{
		...
		private function initStyles() : void
		{
			...
			Style.TOOL_BAR = 0x333333;
			Style.LINE_COLOR = 0xFFFFFF;
			*/
		}
		...
		private function initToolbar() : void
		{
			...
			_version = new Label();
			_version.text = "Parameter Controller v" + VERSION;
			_version.alpha = 0.5;
			...
			_toggle.graphics.beginFill(Style.TOOL_BAR, 0.9);
			...
			_lineH.bitmapData = new BitmapData(5, 1, false, Style.LINE_COLOR);			_lineV.bitmapData = new BitmapData(1, 5, false, Style.LINE_COLOR);
		...
		private function draw() : void
		{
			...
			for (i = 0; i < _container.numChildren; i++)
			{
				...
				for (j = 0; j < column.numChildren; j++)
				{
					...
					for (k = 0; k < group.numChildren - 1; k++)
					{
						...
						component.graphics.lineStyle(0, Style.COMPONENT_BACKGROUND, 0.1);
					...
					group.graphics.beginFill(Style.TOOL_BAR, 0.9);
			...
			_toolbar.graphics.beginFill(Style.TOOL_BAR, 0.9);
